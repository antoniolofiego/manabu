	...
	return (
		<Link href={url}>
			<a className='relative w-full group'>
				{pageIsActive(url) ? (
					<span className='absolute left-0 w-2 h-full bg-black'></span>
				) : (
					<span className='absolute left-0 w-2 h-full transition-all -translate-x-4 bg-black group-hover:translate-x-0' />
				)}
